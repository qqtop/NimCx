...
# of truecolors which are beyond the usual gnome based terminals
...
# randCol2() function allows selection of specific colorsets like "light","red" etc.

hideCursor()
getcxTrueColorSet() # need this as currently not loaded in cx
...
# example of how to put several of cxlinetext objects onto a cxline  , up to 12 are allowed 
# and display them with var. color and text properties
 

let nowlen = $($now()).len
var bframeline = newcxline()
bframeline.startpos = 3
bframeline.endpos = 130
bframeline.linecolor        = randCol2("blue")  
...
# lets assume we have different col segments to display 
bframeline.cxlinetext.textpos = 3
bframeline.cxlinetext.text = fmtx([">" & nowlen],$now())
bframeline.cxlinetext.textcolor = rndcol() 
...
bframeline.cxlinetext2.text = fmtx([">4"],$getrndint(1,100))
bframeline.cxlinetext2.textcolor = skyblue 
bframeline.cxlinetext2.textstyle = {styleReverse}
# 
bframeline.cxlinetext3.textpos = 50 - bframeline.startpos  
bframeline.cxlinetext3.text = fmtx([">12"],ff2(getrndfloat() * 1000.00,5))
bframeline.cxlinetext3.textcolor = rndcol() 
bframeline.cxlinetext3.textstyle = {styleReverse}
# 
bframeline.cxlinetext4.textpos = 70 - bframeline.startpos  
bframeline.cxlinetext4.text = newword(6,6)
bframeline.cxlinetext4.textcolor = rndcol() 
bframeline.cxlinetext4.textstyle = {styleReverse}
#
bframeline.cxlinetext5.textpos = 80 - bframeline.startpos  
bframeline.cxlinetext5.text = newwordCJK(6,6)
bframeline.cxlinetext5.textcolor = randcol2("cl") 
bframeline.cxlinetext5.textstyle = {styleReverse}
#
bframeline.cxlinetext6.textpos = 100 - bframeline.startpos 
bframeline.cxlinetext6.text = $(getrndint(100,999))
bframeline.cxlinetext6.textcolor = rndcol() 
bframeline.cxlinetext6.textstyle = {styleReverse}
#
bframeline.cxlinetext7.textpos = 110 - bframeline.startpos 
bframeline.cxlinetext7.text = "qqTOP"
bframeline.cxlinetext7.textcolor = randcol2("red") 
bframeline.cxlinetext7.textstyle = {styleReverse}
#
bframeline.cxlinetext8.textpos = 120 - bframeline.startpos 
bframeline.cxlinetext8.text = fmtx(["<5",">3"],"Row:",$0)
bframeline.cxlinetext8.textcolor = randcol2("light") 
bframeline.cxlinetext8.textstyle = {styleReverse}
bframeline.newline = ""
#
printLnBiCol(" NIM Ruler : Terminal width")
showruler()
...
for x in 1..<10:   
   ...
   bframeline.startpos = 3
   bframeline.endpos = 130
   bframeline.cxlinetext.text = $now()
   bframeline.cxlinetext2.text = fmtx([">4"],$getrndint(1,100))
   bframeline.cxlinetext3.text = fmtx([">12"],ff2(getrndfloat() * 1000.00,5))
   ...
   bframeline.cxlinetext7.text = "qqTOP"
   bframeline.cxlinetext8.textcolor = randcol2("light") 
   bframeline.cxlinetext8.text = fmtx(["<5",">3"],"Row:",$(x + 1))
   echo()
printcxline(bframeline)  
showCursor()  
